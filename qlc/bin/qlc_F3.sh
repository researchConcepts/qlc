...
#	echo "${bdir}/v0d_verify -q -e ${mode} ${EXP} ${YY1}${MM1}"                 >  ${hdir}/ver0D/mode_${mode}/ver_settings/verify.sh
	echo "${bdir}/v0d_verify -q    ${mode} ${EXP} ${YY1}${MM1}"                 >  ${hdir}/ver0D/mode_${mode}/ver_settings/verify.sh
	fi
	if [ ${mode} == "gaw" ] ;then
	cp -p ${hdir}/ver0D/mode_${mode}/ver_settings/init_settings.txt                               ${hdir}/ver0D/mode_${mode}/ver_settings/${EXP}_settings.txt
...
#	echo "${bdir}/v0d_verify -q -e ${mode} ${EXP} ${v0d_date_range}"        > ${hdir}/ver0D/mode_${mode}/ver_settings/verify.sh
	echo "${bdir}/v0d_verify       ${mode} ${EXP} ${v0d_date_range}"        > ${hdir}/ver0D/mode_${mode}/ver_settings/verify.sh
	fi
	...
	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/taylor_vs_site_global*_24hrs*gif       >> "$texPlotsfile"
 	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/siteplot_060*_24hrs*gif                >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/bias_vs_fcr*_PM2.5_inst*gif            >> "$texPlotsfile"
	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/bias_vs_fcr_global*gif                 >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/hist2d_US*_PM2.5_24hrs*gif             >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/hist2d_nam_rural*_PM2.5_24hrs*gif      >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/hist2d_nam_urban*_PM2.5_24hrs*gif      >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/hist2d_global*_PM2.5_24hrs*gif         >> "$texPlotsfile"
	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/hist2d_global*gif                      >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/median_ob_vs_site_US*_PM2.5_24hrs*gif  >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/scatter_EUS*_PM2.5_24hrs*gif           >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/scatter_WUS*_PM2.5_24hrs*gif           >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/scatter_nam_rural*_PM2.5_24hrs*gif     >> "$texPlotsfile"
#	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/scatter_nam_urban*_PM2.5_24hrs*gif     >> "$texPlotsfile"
	ls    ${pdir}/mode_${mode}/results/exptsets/${EXP}/${v0d_date_range}/images/scatter_global*_24hrs*gif              >> "$texPlotsfile"
