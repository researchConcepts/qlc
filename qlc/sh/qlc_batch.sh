...
if [ "$1" == "" ] ;then
log "type, e.g.:"
log "sqlc b2ro b2rn 2018-12-01 2018-12-31 mars"
log "sqlc b2ro b2rn 2018-12-01 2018-12-31"
log " "
log "Use option 'mars' to retrieve files and then submit a a dependency job once all data have been retrieved."
log "Or, option 'mars' can be skipped, if all data are already present in $HOME/qlc/Results"
log  "________________________________________________________________________________________"
